<template>
    <section class="overflow-hidden">
        <div id="updates" class=" gradient">
                ...
                <div class="flow-root">
                    <ul role="list">
                        <li class="py-5 sm:py-2 mb-4 w-3/5 m-auto" v-for="update in updates" v-bind:key="update.id">
                            <div @click="toggleItem(update)" class="m-auto w-5/6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                                <img class="rounded-t-lg sm:h-52 lg:h-80 xl:h-96 w-full" v-bind:src="'http://localhost/images/' + update.image" alt="">
                                <div class="icon">
                                ...
                                <div class="p-5">
                                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white text-center">{{ update.title}}</h5>
                                    <p :class="update.isVisible ? activeClass : 'hidden'" class="mb-3 font-normal text-gray-700 dark:text-gray-400" v-html="update.content"></p>
                                </div>
                            </div>
