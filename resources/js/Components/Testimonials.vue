        ...
        <section id="testimonials" class="py-5">
            ...
            <div class="relative slide">
                <div class="carousel-inner relative overflow-hidden w-full">
                    <div v-for="(testimonial, i) in testimonials" :id="`slide-${i}`" :key="i" :class="`${active === i ? 'active' : 'left-full'}`" class="carousel-item inset-0 relative w-full transform transition-all duration-200 ease-in-out">
                        <div class="quote" >
                            <span class="qmark qleft">❝</span>
                            <blockquote>
                                <div v-html="testimonial.comment"></div>
                                <div v-if="testimonial.stars === 1">
                                    <span style="font-size:200%;color:gold;">★</span>
                                </div>
